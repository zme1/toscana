                    ...
                    <div class="svg">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 850 450">
                            <g transform="translate(400,400)">
                                ...
                                <line x1="-{$xLength div 2}" y1="-{$yHeight}" x2="-{$xLength div 2}"
                                    y2="0" stroke="black" stroke-width="1"/>
                                <!-- Center vertical line -->
                                <line x1="0" y1="0" x2="0" y2="-{$yHeight}" stroke="black"
                                    stroke-width="1"/>
                                <!-- Right vertical line -->
                                <line x1="{$xLength div 2}" y1="-{$yHeight}" x2="{$xLength div 2}"
                                    y2="0" stroke="black" stroke-width="1"/>
                                ...
                                <!-- Top horizontal line -->
                                <line x1="-{$xLength div 2}" y1="-{$yHeight}" x2="{$xLength div 2}"
                                    y2="-{$yHeight}" stroke="black" stroke-width="1"/>
                        ...
                        <line x1="{$xScale *55}" y1="-{$yHeight}" x2="{$xScale * 55}" y2="0" stroke="black" stroke-width="0.25" stroke-dasharray="10, 5"/> -->
                                ...
                                <line x1="{$xScale *10}" y1="-{$yHeight}" x2="{$xScale * 10}" y2="0"
                                    stroke="black" stroke-width="0.5" stroke-dasharray="10, 5"/>
                                ...
                                <line x1="-{$xScale *10}" y1="-{$yHeight}" x2="-{$xScale * 10}"
                                    y2="0" stroke="black" stroke-width="0.5"
