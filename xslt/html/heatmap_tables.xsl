    ...
    <xsl:template match="/">
                <xsl:for-each select="$persons">
                    ...
                    <xsl:for-each select="$dates">
                        ...
                        <xsl:variable name="activity" select="$root//act[@ref eq $currentPerson and $currentDate eq date/@when]"/>
                        <table class="heatToggle {$idPerson[1]}{$idDate[1]}">
                            <tr>
                                <th>Name</th>
                                <td>Date</td>
                            ...
                            <tr>
                                ...
                                <td><xsl:for-each select="$activity">
