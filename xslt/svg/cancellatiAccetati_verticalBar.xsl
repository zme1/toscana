            ...
            <div class="cancellatiSvg">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 430">
                    <g transform="translate(385,370)">
                        ...
                        <line x1="0" y1="0" x2="0" y2="-{$yHeight}" stroke="white" stroke-width="1"/>
                        <!-- Right vertical line -->
                        <line x1="{$xLength div 2}" y1="-{$yHeight}" x2="{$xLength div 2}" y2="0"
                            stroke="white" stroke-width="1"/>
                        ...
                        <text x="{$xScale *10}" y="20" text-anchor="middle" style="fill: white;"
                            >10</text>
                        <line x1="{$xScale *20}" y1="-{$yHeight}" x2="{$xScale * 20}" y2="0"
                            stroke="white" stroke-width="0.5" stroke-dasharray="10, 5"/>
                        <text x="{$xScale *20}" y="20" text-anchor="middle" style="fill: white;"
                            >20</text>
                        <line x1="{$xScale *30}" y1="-{$yHeight}" x2="{$xScale * 30}" y2="0"
                            stroke="white" stroke-width="0.5" stroke-dasharray="10, 5"/>
                        <text x="{$xScale *30}" y="20" text-anchor="middle" style="fill: white;"
                            >30</text>
                        <line x1="{$xScale *40}" y1="-{$yHeight}" x2="{$xScale * 40}" y2="0"
                            stroke="white" stroke-width="0.5" stroke-dasharray="10, 5"/>
                        <text x="{$xScale *40}" y="20" text-anchor="middle" style="fill: white;"
                            >40</text>
                        <line x1="{$xScale *50}" y1="-{$yHeight}" x2="{$xScale * 50}" y2="0"
                            stroke="white" stroke-width="0.5" stroke-dasharray="10, 5"/>
                        <text x="{$xScale *50}" y="20" text-anchor="middle" style="fill: white;"
                            >50</text>
                        <line x1="{$xScale *60}" y1="-{$yHeight}" x2="{$xScale * 60}" y2="0"
                            stroke="white" stroke-width="0.5" stroke-dasharray="10, 5"/>
                        <text x="{$xScale *60}" y="20" text-anchor="middle" style="fill: white;"
                            >60</text>
        ...
        <div class="table" id="accettati{$date}">
            <table>
                ...
                <tr>
                    ...
                    <xsl:choose>
                        <xsl:when test="count(descendant::list[@type = 'cancellati']/item) gt 0">
                            <td class="out">
                                <xsl:value-of
                        ...
                        <xsl:when test="count(descendant::list[@type = 'cancellati']/item) eq 0">
                            <td class="out">
                                <xsl:text>[ No dismissed members ]</xsl:text>
                            </td>
                        </xsl:when>
                    </xsl:choose>
                </tr>
