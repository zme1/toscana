...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <div class="grammar">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 680">
                <g transform="translate(120,550)">
                    ...
                    <!-- Figure label, x- and y-axis labels, legend -->
                    <text x="" y="" text-anchor="" font-size="30px" fill="white"></text>
                    ...
                    <line x1="0" y1="-{$yLength}" x2="{$xLength}" y2="-{$yLength}" stroke="white" stroke-width="1"/>
                    <line x1="{$xLength}" y1="0" x2="{$xLength}" y2="-{$yLength}" stroke="white" stroke-width="1"/>
                    <line x1="0" y1="0" x2="0" y2="-{$yLength}" stroke="white" stroke-width="1"/>
                    
                    <!-- X-axis milestones -->
                    <line x1="{$xLength * .1}" y1="0" x2="{$xLength * .1}" y2="-10" stroke="white" stroke-width="1"/>
                    <line x1="{$xLength * .2}" y1="0" x2="{$xLength * .2}" y2="-10" stroke="white" stroke-width="1"/>
                    <line x1="{$xLength * .3}" y1="0" x2="{$xLength * .3}" y2="-10" stroke="white" stroke-width="1"/>
                    <line x1="{$xLength * .4}" y1="0" x2="{$xLength * .4}" y2="-10" stroke="white" stroke-width="1"/>
                    <line x1="{$xLength * .5}" y1="0" x2="{$xLength * .5}" y2="-10" stroke="white" stroke-width="1"/>
                    <line x1="{$xLength * .6}" y1="0" x2="{$xLength * .6}" y2="-10" stroke="white" stroke-width="1"/>
                    <line x1="{$xLength * .7}" y1="0" x2="{$xLength * .7}" y2="-10" stroke="white" stroke-width="1"/>
                    ...
                    <line x1="0" y1="-{$yLength * .2}" x2="10" y2="-{$yLength * .2}" stroke="white" stroke-width="1"/>
                    <line x1="0" y1="-{$yLength * .3}" x2="10" y2="-{$yLength * .3}" stroke="white" stroke-width="1"/>
                    <line x1="0" y1="-{$yLength * .4}" x2="10" y2="-{$yLength * .4}" stroke="white" stroke-width="1"/>
                    <line x1="0" y1="-{$yLength * .5}" x2="10" y2="-{$yLength * .5}" stroke="white" stroke-width="1"/>
                    <line x1="0" y1="-{$yLength * .6}" x2="10" y2="-{$yLength * .6}" stroke="white" stroke-width="1"/>
                    <line x1="0" y1="-{$yLength * .7}" x2="10" y2="-{$yLength * .7}" stroke="white" stroke-width="1"/>
    ...
    <xsl:template match="teiCorpus/teiCorpus" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="{$precedingCount * $angXValue}" y="-{$naCount * $angYValue}" height="{$naCount * $angYValue}" width="{$totalCount * $angXValue}" fill="#BFA179" stroke="white"/>
        <rect x="{$precedingCount * $angXValue}" y="-{($grammaticalCount + $naCount) * $angYValue}" height="{$grammaticalCount * $angYValue}" width="{$totalCount * $angXValue}" fill="#3E6E63" stroke="white"/>
        <rect x="{$precedingCount * $angXValue}" y="-{($grammaticalCount + $ungrammaticalCount + $naCount) * $angYValue}" height="{$ungrammaticalCount * $angYValue}" width="{$totalCount * $angXValue}" fill="#CE4B29" stroke="white"/>
    </xsl:template>
</xsl:stylesheet>